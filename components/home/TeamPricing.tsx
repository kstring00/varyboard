...
/**
 * The athletes card's one CTA ("Outfit your team") opens the existing team inquiry form in the card.
...
export function TeamPricing({ label }: { label: string }) {
  ...
  return (
    <div id={TEAM_FORM_ANCHOR} className="who-team">
      <button type="button" className="who-card__more" aria-expanded={open} aria-controls={panel} onClick={() => setOpen((v) => !v)} data-team-toggle>
        {label}
      </button>
      <div id={panel} hidden={!open} className="who-team__panel">
